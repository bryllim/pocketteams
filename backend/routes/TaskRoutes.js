...
const {getTasks,createTask,getTasksBySection,deleteTaskById,updateTaskById,updateTaskDescriptionById,updateTaskAssignedUsersById,updateTaskPriorityById,updateTaskNameById} = require("../controllers/TasksController");
...
router.route("/update/assignedusers/:id").put(protect,updateTaskAssignedUsersById)
